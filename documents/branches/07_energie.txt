...
Cette branche vise à rendre le lieu 100% autonome en électricité. Il comprend le dimensionnement, l'installation et la gestion d'un système complet de production (panneaux solaires), de stockage (batteries) et de distribution d'énergie.

Assurer une alimentation électrique fiable, durable et entièrement renouvelable pour tous les besoins du lieu (logements, espaces communs, coworking), sans dépendre du réseau public.
...
## 4. Synthèse des besoins énergétiques par branche
| Branche                  | Consommation Estimée (Wh/jour) | Notes                               |
| ------------------------- | ------------------------------ | ----------------------------------- |
| 02 - Logements            | ~1 500                         | + Bois pour le chauffage            |
| 03 - Cuisine              | ~1 600                         | + Biogaz pour la cuisson            |
| 04 - Sanitaires           | ~2 355                         | + Bois pour l'eau chaude & chauffage|
| 05 - Vie sociale (dômes x2) | ~1 200                         | + Bois pour le chauffage            |
| 06 - Coworking            | ~20 160                        | Principal pôle de consommation      |
| 08 - Eau                  | ~3 585                         | Pompes, filtration et chauffe-eau solaire/gaz   |
| 09 - Alimentation         | ~900                           | Saisonnier (irrigation x3)          |
| 10 - Atelier              | ~2 900                         | Journées de construction            |
| **TOTAL ESTIMÉ**          | **~34 200 Wh/jour**            |                                     |
...
- **Hypothèses :**
  - Besoin journalier : ~34.2 kWh.
  - Objectif d'autonomie batterie : 0.5 jour (complété par générateur).
...
- **Calcul du Stockage (Batteries) :**
  - Capacité utile requise : 34.2 kWh * 0.5 jour = 17.1 kWh.
  - Capacité totale (avec DoD 80%) : 17.1 / 0.8 = ~21.4 kWh.
  - **=> Objectif : ~22 kWh de batteries.**

- **Calcul de la Production (Panneaux) :**
  - Puissance nécessaire : 34.2 kWh / 2.5h = 13.68 kWc.
  - Puissance à installer (avec 20% pertes) : 13.68 * 1.2 = ~16.5 kWc.
  - **=> Objectif : ~16.5 kWc de panneaux.**
...
| ------------------ | -------------------------------------------- | ----------- |
| Production         | Panneaux solaires photovoltaïques (~16.5 kWc)| ~12 600 €   |
| Stockage           | Batteries Lithium (~22 kWh)                  | ~8 600 €    |
| Secours            | Générateur à essence/biogaz (~10-15kW)       | ~2 500 €    |
| Conversion/Gestion | Onduleur, régulateur de charge, moniteur...  | ~4 500 €    |
| Distribution       | Câbles, disjoncteurs, tableaux, prises...    | ~3 000 €    |
...
- **Note :** Le chauffe-eau pour l'eau chaude sanitaire sera au gaz (alimenté par le biogaz des toilettes), donc non inclus dans la consommation électrique.

## 8. Plan d'action / tâches
- [ ] **Action critique :** Valider les estimations de consommation de chaque branche.
